...
const ROADMAP_DETECTORS: Detector[] = [
  {
    ...
    status: "phase2",
    pkg: "@framefind/core",
    desc: "Fatigue scoring from blink rate and eye closure duration",
    detail: "Blink events + PERCLOS → temporal window → drowsiness score",
  },
  {
    id: "attention",
    icon: Brain,
  ...
  },
  {
    ...
    status: "phase2",
    pkg: "@framefind/core",
    desc: "Iris-based screen gaze estimation",
    detail: "MediaPipe Iris → geometric gaze vector → screen coordinates",
  },
  {
    id: "emotion",
    icon: Smile,
    ...
    status: "phase3",
    pkg: "@framefind/core",
    desc: "Facial expression classification",
    detail: "Face crop → CNN classifier → neutral/happy/sad/angry/surprised",
  },
  {
    id: "mask",
    icon: ShieldOff,
    ...
    status: "phase3",
    pkg: "@framefind/core",
    desc: "Face covering detection",
    detail: "128×128 face crop → MobileNetV3 → mask probability",
  },
];
